...
/-- post 데이터의 개수 --/
SELECT count(*) FROM Sopt.post;

/-- post title만 가져오기 --/
SELECT title FROM Sopt.post;

/-- 아무 값이나 INSERT 해보기 --/
INSERT INTO Sopt.post (author, title, content, createdAt) VALUES ('Myeong Hui', '26th our sopt', 'blablablabla', '5/16/2020');
...
/-- postIdx가 4인 데이터 지우기 --/
DELETE FROM Sopt.sopt WHERE postIdx = 4;